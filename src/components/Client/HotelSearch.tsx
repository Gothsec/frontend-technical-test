...
try {
    ...
    // Auto-scroll to results section after a small delay
    setTimeout(() => {
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        {isLoading ? (
            ...
            <p className="ml-4 text-lg font-semibold text-indigo-600">Buscando hoteles...</p>
            </div>
        ) : (
            <>
            {searched && results.length > 0 && (
                <div className="transition-all duration-300 ease-in-out">
                <h3 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2 border-indigo-100">Resultados de búsqueda</h3>
                <div className="overflow-y-auto max-h-[500px] pr-2 scroll-smooth" style={{ scrollBehavior: 'smooth' }}>
                    ...
                    {results.map((hotel: Hotel) => (
                        ...
                        <div className="flex flex-col sm:flex-row justify-between">
                            ...
                            <div className="flex items-center mb-3 text-yellow-500">
                                <span className="text-sm text-gray-500">Ciudad: {hotel.city}</span>
                            </div>
            ...
            {searched && results.length === 0 && (
                ...
                <p className="text-gray-700 text-lg">
                    No se encontraron hoteles en <span className="font-semibold">"{city}"</span>
                </p>
                <p className="text-gray-500 mt-2">Por favor, intenta con otra ciudad o fechas diferentes.</p>
                </div>
            )}
            </>
        )}
